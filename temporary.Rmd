...
This material is adapted in part from the fine [introduction to using R as a GIS](https://github.com/f-tonini/GIS610_SpatialR) by Francesco Tonini, post-doctoral scholar with the [Center for Geospatial Analytics](https://cnr.ncsu.edu/geospatial/) at North Carolina State University. 
